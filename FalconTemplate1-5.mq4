...
extern double  VolBasedTPMultipler = 4; // Take Profit Amount in units of Volatility
...
extern double  VolBasedSLMultipler_Hidden = 0; // Stop Loss Amount in units of Volatility
...
extern double  VolBasedTPMultipler_Hidden = 0; // Take Profit Amount in units of Volatility
...
extern string  Header7 = "----------Volatility Measurement Settings-----------";
extern int     atr_period = 14;

extern string  Header8 = "----------Max Orders-----------";
extern int     MaxPositionsAllowed = 3;

extern string  Header9 = "----------Set Max Loss Limit-----------";
extern bool    IsLossLimitActivated = False;
extern double  LossLimitPercent = 50; 

extern string  Header10 = "----------EA General Settings-----------";
...
int start()
  {
      ...
      //----------TP, SL and Breakeven Stops Variables-----------
...
// This function set breakeven stops for all positions
